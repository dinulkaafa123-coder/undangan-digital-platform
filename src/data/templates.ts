...
export const templates: TemplateMeta[] = [
  ...
  },
  {
    ...
    slug: "velvet-depth",
    name: "Velvet Depth",
    tagline: "Kartu foto beludru 3 lapis, bingkai emas benar-benar mengambang di depan",
    category: "3d",
    tags: ["3d", "luxury"],
    description:
      "Setiap foto tersusun dari tiga lapisan nyata dalam ruang perspective -- tirai belakang blur, foto miring di tengah, bingkai emas tebal mengambang di depan -- depth yang benar-benar terlihat, bukan efek datar.",
    colors: ["#1a0505", "#d4af37", "#f0e5d8"],
    thumbnail: "https://images.unsplash.com/photo-1621801306185-8c0ccf9c8eb8?w=600&h=900&fit=crop&crop=faces&auto=format&q=80",
    isPremium: true,
    isThreeD: true,
    badge: "exclusive",
  ...
  },
  {
    ...
    slug: "marble-atrium",
    name: "Marble Atrium",
    tagline: "Lorong kolom marmer berlapis yang benar-benar memanjang ke kedalaman",
    category: "3d",
    tags: ["3d", "elegant"],
    description:
      "Empat lapis kolom pada kedalaman berbeda menciptakan aula marmer yang terasa memanjang sungguhan -- bukan satu gambar datar, tapi ruang 3D nyata yang dilalui saat undangan dibuka.",
    colors: ["#ffffff", "#c9a86a", "#2f2a22"],
    thumbnail: "https://images.unsplash.com/photo-1606216836537-eea72a939072?w=600&h=900&fit=crop&crop=faces&auto=format&q=80",
    isPremium: true,
    isThreeD: true,
    badge: "exclusive",
  ...
  {
    id: "48",
    slug: "floating-petals-3d",
    name: "Floating Petals 3D",
    tagline: "Depth-of-field asli: kelopak dekat & jauh mengabur sesuai jaraknya",
    category: "3d",
    tags: ["3d", "floral", "romantic"],
    description:
      "Kelopak bunga di beberapa kedalaman dengan blur yang meningkat sesuai jaraknya, seperti lensa kamera sungguhan -- foto pasangan tetap tajam di tengah, lapisan depan & belakang mengabur secara alami.",
    colors: ["#fdf6f2", "#c98098", "#e8b4c8"],
    thumbnail: "https://images.unsplash.com/photo-1519741497674-611481863552?w=600&h=900&fit=crop&crop=faces&auto=format&q=80",
    isPremium: true,
    isThreeD: true,
    badge: "exclusive",
  ...
  },
  {
    ...
    slug: "obsidian-depth",
    name: "Obsidian Depth",
    tagline: "Tiga panel kaca bersudut melayang dalam ruang 3D yang gelap dramatis",
    category: "3d",
    tags: ["3d", "cinematic", "luxury"],
    description:
      "Panel kaca dimiringkan ke sumbu berbeda dan ditumpuk berjenjang -- terasa seperti pecahan kaca melayang di ruang 3D sungguhan, bukan kartu datar yang ditempel efek bayangan.",
    colors: ["#050505", "#c9a24b", "#e9e2d0"],
    thumbnail: "https://images.unsplash.com/photo-1606216769783-a7dbe227a17f?w=600&h=900&fit=crop&crop=faces&auto=format&q=80",
    isPremium: true,
    isThreeD: true,
    badge: "exclusive",
    price: 100000,
  ...
  {
    id: "50",
    slug: "golden-gate-depth",
    name: "Golden Gate Depth",
    tagline: "Lorong gerbang emas berjenjang, terasa benar-benar dilalui",
    category: "3d",
    tags: ["3d", "islamic"],
    eventType: "khitanan",
    description:
      "Tiga lengkung gerbang pada kedalaman berjenjang menciptakan lorong yang terasa memanjang sungguhan -- foto anak muncul di ujung lorong, dikelilingi lengkung yang membesar ke arah kamera.",
    colors: ["#0f3d2e", "#d4af37", "#f6f1e2"],
    thumbnail: "https://images.unsplash.com/photo-1744973004605-118c8be37da4?w=600&h=900&fit=crop&crop=faces&auto=format&q=80",
    isPremium: true,
    isThreeD: true,
  ...
  },
  {
    ...
    slug: "balloon-depth",
    name: "Balloon Depth",
    tagline: "Balon-balon berlapis kedalaman, dekat besar tajam, jauh kecil buram",
    category: "3d",
    tags: ["3d"],
    eventType: "birthday",
    description:
      "Balon pesta tersebar di beberapa kedalaman berbeda -- yang jauh lebih kecil & buram, yang dekat lebih besar & tajam -- menciptakan ruang 3D yang benar-benar terasa mengelilingi foto ulang tahun.",
    colors: ["#fff7ec", "#ff6f91", "#5cc9ff"],
    thumbnail: "https://images.unsplash.com/photo-1544155892-b2b6c64204fc?w=600&h=900&fit=crop&crop=faces&auto=format&q=80",
    isPremium: true,
    isThreeD: true,
    badge: "exclusive",
  ...
  {
    id: "52",
    slug: "academic-hall-depth",
    name: "Academic Hall Depth",
    tagline: "Aula pilar wisuda berlapis yang benar-benar memanjang",
    category: "3d",
    tags: ["3d", "elegant"],
    eventType: "school",
    description:
      "Deretan pilar pada beberapa kedalaman menciptakan aula wisuda yang terasa memanjang sungguhan, dengan laurel wreath & topi toga melayang di lapisan terdepan saat undangan dibuka.",
    colors: ["#f4f1e6", "#0d1b3a", "#c9a24b"],
    thumbnail: "https://images.unsplash.com/photo-1590012314607-cda9d9b699ae?w=600&h=900&fit=crop&crop=faces&auto=format&q=80",
    isPremium: true,
    isThreeD: true,
    badge: "exclusive",
  ...
  },
  {
    ...
    slug: "skyline-depth",
    name: "Skyline Depth",
    tagline: "Cakrawala gedung berlapis parallax, benar-benar berkedalaman",
    category: "3d",
    tags: ["3d", "cinematic"],
    eventType: "corporate",
    description:
      "Siluet gedung pada beberapa kedalaman menciptakan cakrawala kota yang terasa nyata -- gedung jauh kecil & gelap, gedung dekat besar & tajam, panel konten melayang tegas di depannya.",
    colors: ["#ffffff", "#0f1620", "#c9a24b"],
    thumbnail: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=600&h=900&fit=crop&crop=faces&auto=format&q=80",
    isPremium: true,
    isThreeD: true,
    badge: "exclusive",
  ...
  },
  {
    ...
    slug: "mihrab-depth",
    name: "Mihrab Depth",
    tagline: "Lorong lengkung mihrab berjenjang dengan mandala berputar di kejauhan",
    category: "3d",
    tags: ["3d", "islamic"],
    eventType: "religious",
    description:
      "Beberapa lengkung mihrab bersarang pada kedalaman berjenjang menciptakan lorong yang benar-benar memanjang, dengan mandala berputar lambat di lapisan paling belakang.",
    colors: ["#0f3d2e", "#d4af37", "#f6f1e2"],
    thumbnail: "https://images.unsplash.com/photo-1606981693736-62d6c4954ba5?w=600&h=900&fit=crop&auto=format&q=80",
    isPremium: true,
    isThreeD: true,
    badge: "exclusive",
    price: 90000,
  ...
  {
    id: "55",
    slug: "lantern-hall-depth",
    name: "Lantern Hall Depth",
    tagline: "Aula lentera berlapis kedalaman yang terasa benar-benar mengelilingi",
    category: "3d",
    tags: ["3d", "islamic"],
    eventType: "religious",
    description:
      "Lentera-lentera pada beberapa kedalaman menciptakan aula malam yang benar-benar berkedalaman -- lentera jauh kecil & buram, lentera dekat besar & bercahaya, konten melayang di tengah ruang.",
    colors: ["#3a1010", "#d4af37", "#faf3ee"],
    thumbnail: "https://images.unsplash.com/photo-1670514862391-df20ad00b330?w=600&h=900&fit=crop&auto=format&q=80",
    isPremium: true,
    isThreeD: true,
    badge: "exclusive",
    price: 90000,
